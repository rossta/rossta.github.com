...
As we'll see, Webpacker is a very different beast than the Rails asset pipeline. We need a different mental model to understand how it works. We also need to follow a few basic guidelines to deliver JavaScript correctly and avoid falling victim to overpacking.
